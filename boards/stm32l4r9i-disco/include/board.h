...
/**
 * @defgroup    boards_stm32l476g-disco STM32L4R9I-DISCO
 * @ingroup     boards
 * @brief       Support for the STM32L4R9I-DISCO board
 * @{
 *
 * @file
 * @brief       Board specific definitions for the STM32L4R9I-DISCO board
 *
 ...
 * @{
 */
#define LED0_PIN            GPIO_PIN(PORT_H, 4)
#define LED0_MASK           (1 << 4)

#define LED0_ON             (GPIOH->BSRR = LED0_MASK)
#define LED0_OFF            (GPIOH->BSRR = (LED0_MASK << 16))
#define LED0_TOGGLE         (GPIOH->ODR  ^= LED0_MASK)
