 ...
 *
 * @file
 * @brief       Peripheral MCU configuration for the STM32L4R9I-DISCO board
 *
...
#define CLOCK_MSI_ENABLE    (0) /* FIXME: stmclk_init_sysclk disable HSE when this is enabled */
